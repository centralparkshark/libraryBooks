...
function addBookToLibrary() {
    ...
    */
    ...
    // change status 
    /*
    let svgTest = document.querySelector('.statusLogo');
    svgTest.addEventListener("click", function() {
        this.style.fill = "red";
    });
    */
   //switch for read/unread
...
function openForm() {
    ...
    document.getElementById("gray").style.backgroundColor = "rgba(61, 61, 61, 0.7)";
    document.getElementById("gray").style.zIndex= 20;
    document.getElementById("add").style.backgroundColor = "rgba(61, 61, 61, 0.7)"
    document.getElementById("add").style.color = "lightslategray";
}

function closeForm() {
    document.getElementById("myForm").style.display = "none";
    document.getElementById("gray").style.backgroundColor = "rgba(61, 61, 61, 0.0)";
    document.getElementById("gray").style.zIndex= -1;
    document.getElementById("add").style.backgroundColor = "darkslategray"
